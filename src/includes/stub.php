...
${__FILE__}['version'] = '170808-RC'; //version//
...
foreach (['Classes', 'Classes\\MenuPage\\Options', 'Traits\\Shared', 'Traits\\Ac', 'Traits\\Plugin', 'Interfaces\\Shared'] as ${__FILE__}['_sub_namespace']) {
