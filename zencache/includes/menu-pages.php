...
namespace zencache // Root namespace.
{
	...
	class menu_pages // Plugin options.
	{
		...
		public function options()
		{
			...
			echo '      <a href="'.esc_attr('http://zencache.com/prices/').'" target="_blank"><i class="fa fa-heart-o"></i> '.__('Pro Upgrade', $this->plugin->text_domain).'</a>'."\n";
			...
			if($this->plugin->is_pro_preview())
			{
				...
				echo '            <option value="0">'.__('No, leave the Auto-Cache Engine disabled please.', $this->plugin->text_domain).'</option>'."\n";
				echo '            <option value="1" selected="selected">'.__('Yes, I want the Auto-Cache Engine to keep pages cached automatically.', $this->plugin->text_domain).'</option>'."\n";
				echo '         </select></p>'."\n";
				echo '      <hr />'."\n";
			...
			if($this->plugin->is_pro_preview())
			{
				...
				echo '            <option value="0">'.__('No, I do NOT want CDN filters applied at runtime.', $this->plugin->text_domain).'</option>'."\n";
				echo '            <option value="1" selected="selected">'.__('Yes, I want CDN filters applied w/ my configuration below.', $this->plugin->text_domain).'</option>'."\n";
				echo '         </select></p>'."\n";
				echo '      <hr />'."\n";
				echo '      <div class="plugin-menu-page-panel-if-enabled">'."\n";
				echo '         <h3>'.__('CDN Host Name (Required)', $this->plugin->text_domain).'</h3>'."\n";
