	...
	class menu_pages // Plugin options.
	{
		...
		public function options()
		{
			...
			if($this->plugin->is_pro_preview())
			{
				...
				echo '      <hr />'."\n";
				echo '      <h3>'.__('Purging the Cache (Automatically)', $this->plugin->text_domain).'</h3>'."\n";
				...
				echo '            <option value="1" selected="selected">'.__('Yes, enable Quick Cache notifications in the Dashboard when changes are detected &amp; one or more cache files are purged automatically.', $this->plugin->text_domain).'</option>'."\n";
				...
				echo '            <option value="1" selected="selected">'.__('Yes, if any single Post/Page is purged/reset; also purge the "Home Page".', $this->plugin->text_domain).'</option>'."\n";
				...
				echo '         </select></p>'."\n";
				echo '      <h3>'.__('Auto-Purge Designated "Posts Page" Too?', $this->plugin->text_domain).'</h3>'."\n";
				...
				echo '            <option value="1" selected="selected">'.__('Yes, if any single Post/Page is purged/reset; also purge the "Posts Page".', $this->plugin->text_domain).'</option>'."\n";
				...
				echo '            <option value="1" selected="selected">'.__('Yes, if any single Post/Page is purged/reset; also purge the "Author Page".', $this->plugin->text_domain).'</option>'."\n";
				...
				echo '         </select></p>'."\n";
				echo '      <h3>'.__('Auto-Purge "Category Archives" Too?', $this->plugin->text_domain).'</h3>'."\n";
				echo '      <p>'.__('On many sites, each post is associated with at least one Category. Each category then has an archive view that contains all the posts within that category. Therefore, if a single Post/Page is changed in some way; and Quick Cache purges/resets the cache for a single Post/Page, would you like Quick Cache to also purge any existing cache files for the associated Category archive views?', $this->plugin->text_domain).'</p>'."\n";
				echo '      <p><select name="'.esc_attr(__NAMESPACE__).'[save_options][cache_purge_term_category_enable]">'."\n";
				echo '            <option value="1" selected="selected">'.__('Yes, if any single Post/Page is purged/reset; also purge the associated Category archive views.', $this->plugin->text_domain).'</option>'."\n";
				...
				echo '         </select></p>'."\n";
				echo '      <h3>'.__('Auto-Purge "Tag Archives" Too?', $this->plugin->text_domain).'</h3>'."\n";
				...
				echo '            <option value="1" selected="selected">'.__('Yes, if any single Post/Page is purged/reset; also purge the associated Tag archive views.', $this->plugin->text_domain).'</option>'."\n";
				...
				echo '         </select></p>'."\n";
				echo '      <h3>'.__('Auto-Purge "Custom Term Archives" Too?', $this->plugin->text_domain).'</h3>'."\n";
