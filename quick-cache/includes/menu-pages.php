					...
					if(plugin()->is_pro_preview())
						{
							...
							echo '            <option value="1"'.selected(plugin()->options['admin_bar_enable'], '1', FALSE).'>'.__('Yes, enable the &quot;Clear Cache&quot; button in the WordPress admin bar.', plugin()->text_domain).'</option>'."\n";
